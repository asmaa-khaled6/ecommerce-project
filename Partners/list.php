    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            ...
            <p class="subtitle text-muted">
                Manage all your registered partners
            </p>
                                ...
                                <tr>
                                    ...
                                    <?php if (isAdmin()) { ?>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a
                                                href="edit.php?id=<?php echo $partner['id']; ?>"
                                            ...
                                            <a
                                                href="list.php?delete_id=<?php echo $partner['id']; ?>"
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    <?php if (isAdmin()) { ?>
                                        ...
                                        Click "Add New Partner" to create one.
